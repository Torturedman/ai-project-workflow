...
**Tech Stack:** Node.js 24 LTS、TypeScript 6、npm、Commander、Zod、Execa、Pino、YAML、Vitest、Playwright、SQLite。MVP 首先实现 `node-next` Profile，随后补齐 `python-fastapi-react` 与 `java-spring-vue`。精确依赖版本以 `docs/development-plan/dependency-versions.md` 为准。
